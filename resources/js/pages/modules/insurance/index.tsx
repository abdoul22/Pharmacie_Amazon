...
const InsuranceIndexPage: React.FC = () => {
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Assurances</h1>
          <p className="text-muted-foreground">Gestion des compagnies d'assurance et remboursements</p>
        </div>
        <Button>
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="text-center py-8">
          ...
          <p className="text-blue-700">Pages CRUD pour les assurances: index, create, show, edit</p>
        </CardContent>
      </Card>
    </div>
  );
