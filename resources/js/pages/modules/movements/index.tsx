...
const MovementsIndexPage: React.FC = () => {
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="text-center py-8">
          <ArrowUpDown className="mx-auto h-12 w-12 text-blue-500 mb-4" />
          <h3 className="text-lg font-semibold text-blue-900 mb-2">Module en développement</h3>
          <p className="text-blue-700">Pages CRUD pour les mouvements: index, create, show, edit</p>
        </CardContent>
      </Card>
    </div>
  );
...
export default MovementsIndexPage;
